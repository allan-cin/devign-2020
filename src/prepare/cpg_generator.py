...
def joern_parse(joern_path, input_path, output_path, file_name):
    ...
    joern_parse_call = subprocess.run(["joern-parse", input_path, "--output", output_path + out_file],
...
def joern_create(joern_path, in_path, out_path, cpg_files):
    joern_process = subprocess.Popen(["joern"], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
    json_files = []
